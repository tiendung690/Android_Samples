...
package jp.ohwada.android.vision2.ui;
...
import jp.ohwada.android.vision2.util.DisplayUtil ;
...
private void setCameraInfo() {
                ...
                if(size == null) return;
                    ...
                    int previewWidth = imageWidth / SCALE_FACTOR;
                    int previewHeight = imageHeight / SCALE_FACTOR;

                    if(isSwapped) {
                        previewWidth = imageHeight / SCALE_FACTOR;
                        previewHeight = imageWidth / SCALE_FACTOR;
                    }
