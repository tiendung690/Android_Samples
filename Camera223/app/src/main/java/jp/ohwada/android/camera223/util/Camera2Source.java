 ...
 */ 
    ...
    public interface PreviewCallback {
        void onPreviewFrame(byte[] data, long timestamp);
    }
...
public boolean isStarted() {
        boolean ret = (mCameraDevice != null)? true: false;
        return ret;
}
...
private void setUpImageReaderYuv(CameraCharacteristics characteristics) {
        ...
        log_d("create ImageReaderYuv: " +  mImageWidth +" x " + mImageHeight);
        try {
